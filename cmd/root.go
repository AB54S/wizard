...
import (
	...
	"github.com/ab54s/wizard/internal/ui"
...
var rootCmd = &cobra.Command{
	Use:   "wizard",
	Short: "System Information CLI",
	Long:  `Wizard displays system stats (CPU, GPU, Memory, Kernel, DE) in the terminal`,
	// Uncomment the following line if your bare application
	// has an action associated with it:
	Run: func(cmd *cobra.Command, args []string) {
		systemState := ui.NewSystemModel()
		terminalUI := tea.NewProgram(systemState, tea.WithAltScreen())

		if _, err := terminalUI.Run(); err != nil {
			fmt.Printf("Ui crashed: %v", err)
		}
	},
}
